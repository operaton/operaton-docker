...
# Otherwise [defaults](https://github.com/operaton/operaton-bpm-platform/blob/master/distro/run/assembly/resources/default.yml)
# will be used.
...
CMD="/operaton/internal/run.sh start"
