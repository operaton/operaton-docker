...
CATALINA_HOME="${CATALINA_HOME:-/operaton}"
...
if [ "$JMX_PROMETHEUS" = "true" ] ; then
  ...
  export CATALINA_OPTS="${CATALINA_OPTS:=} -javaagent:/operaton/javaagent/jmx_prometheus_javaagent.jar=${JMX_PROMETHEUS_PORT}:${JMX_PROMETHEUS_CONF}"
fi
